...
public class CreateThirdPartyUserUseCase(UserManager<User> userManager
, IValidateAndGenerateValidUserService validateAndGenerateValidUsernameService): ICreateThirdPartyUserUseCase
{

  private readonly UserManager<User> _userManager = userManager;
  private readonly IValidateAndGenerateValidUserService _validateAndGenerateValidUsernameService = validateAndGenerateValidUsernameService;
