...
public class UnmarkNodeAsDoneUseCase(
 ICheckListRepository checkListRepository): IUnmarkNodeAsDoneUseCase
{
  ...
  public async Task Execute(long nodeId)
  {
    ...
    await _checkListRepository.UnMarkNodeAsDoneAndSaveAsync(node);
  }
