...
public class CreateTopicUseCase(IValidator<CreateTopicDTO> validator,
 IVerifyValidTopicService verifyTopic,
 UserManager<User> userManager, 
 ITopicRepository topicRepository): ICreateTopicUseCase
{
  private readonly UserManager<User> _userManager = userManager;
  private readonly  ITopicRepository _topicRepository = topicRepository;

  private readonly IValidator<CreateTopicDTO> _validator = validator;
  private readonly IVerifyValidTopicService _verifyTopic = verifyTopic;
