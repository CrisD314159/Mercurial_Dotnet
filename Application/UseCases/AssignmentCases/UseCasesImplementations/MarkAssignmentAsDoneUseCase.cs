...
public class MarkAssignmentAsDoneUseCase(IMarkUserAssignmentByStateService markUserAssignmentByStateService): IMarkAssignmentAsDoneUseCase
{
  ...
  { 
    await _markUserAssignmentByStateService.Execute(userId, assignmentId, AssignmentState.DONE);
  }
