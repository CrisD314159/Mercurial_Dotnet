...
public class CreateAssignment(IValidator<CreateAssignmentDTO> validator,
VerifyValidAssignmentService verifyValidAssignmentService,
...
)
{
  ...
  private readonly VerifyValidAssignmentService _verifyValidAssignment= verifyValidAssignmentService;
